<template>
  <el-card>
      <el-form :model="goods" ref="addForm" :rules="rules" label-width="80px">
            ...
            <el-button type="primary" @click="edit">提交修改</el-button>
        </el-form>
  </el-card>
</template>
...
import { getGoodsById, editGoods } from '@/api/goods'
    ...
    methods: {
        ...
        edit() {
            this.$refs.addForm.validate(valid => {
                ...
                if(!this.goods.cover) this.$message("封面不能为空")
                if(this.goods.types.length === 0) this.$message("商品分类不能为空")

                editGoods(this.goods).then(() => {
